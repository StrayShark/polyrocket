...
[![coverage](https://img.shields.io/badge/vitest%20cov-88.2%25%20stmts-brightgreen)](./vitest.config.ts)
...
| Coverage gate | vitest 88.2% stmts / 85.7% branches / 82.5% funcs / 89.1% lines (`vitest.config.ts`) |
