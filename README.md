...
[![coverage](https://img.shields.io/badge/vitest%20cov-89.3%25%20stmts-brightgreen)](./vitest.config.ts)
...
| Coverage gate | vitest 89.3% stmts / 86.4% branches / 84.4% funcs / 90.4% lines (`vitest.config.ts`) |
