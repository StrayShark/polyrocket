...
[![coverage](https://img.shields.io/badge/vitest%20cov-76.8%25%20stmts-green)](./vitest.config.ts)
...
| Test totals | **319 cargo + 615 vitest + 85 Python = 1019/** |
| Coverage gate | vitest 76.8% stmts / 72.6% branches / 68.0% funcs / 78.0% lines (`vitest.config.ts`) |
