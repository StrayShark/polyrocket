...
[![coverage](https://img.shields.io/badge/vitest%20cov-86.8%25%20stmts-brightgreen)](./vitest.config.ts)
...
| Test totals | **348 cargo + 913 vitest + 86 Python + 7 e2e = 1354/** |
| Coverage gate | vitest 86.8% stmts / 84.0% branches / 80.6% funcs / 88.0% lines (`vitest.config.ts`) |
| Comment density | 5/5 PASS (`scripts/check-comment-density.mjs`) |
| Status | v0.85 — auto-bumped by update-readme-coverage.mjs |
