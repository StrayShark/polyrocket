...
[![coverage](https://img.shields.io/badge/vitest%20cov-72.7%25%20stmts-green)](./vitest.config.ts)
...
| Coverage gate | vitest 72.7% stmts / 68.4% branches / 61.3% funcs / 73.8% lines (`vitest.config.ts`) |
