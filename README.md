...
[![coverage](https://img.shields.io/badge/vitest%20cov-89.4%25%20stmts-brightgreen)](./vitest.config.ts)
...
| Coverage gate | vitest 89.4% stmts / 86.4% branches / 84.6% funcs / 90.4% lines (`vitest.config.ts`) |
