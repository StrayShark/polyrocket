...
[![coverage](https://img.shields.io/badge/vitest%20cov-87.5%25%20stmts-brightgreen)](./vitest.config.ts)
...
| Coverage gate | vitest 87.5% stmts / 85.4% branches / 81.6% funcs / 88.6% lines (`vitest.config.ts`) |
