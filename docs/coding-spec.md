...
**版本**：v2.24 · 2026-06-22 (v0.110.2 — LlmStep `default_model` 落库: LlmStep onAdd 加 `llmProviderUpsert` 把 defaultModel 写进 SQLite,5 个国产 provider defaultModel 改为联网查证的最新 stable ID,详见 `polyrocket-llm-management.md` §15.7)
