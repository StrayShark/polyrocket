...
[![coverage](https://img.shields.io/badge/vitest%20cov-78.4%25%20stmts-green)](./vitest.config.ts)
...
| Test totals | **319 cargo + 649 vitest + 85 Python = 1053/** |
| Coverage gate | vitest 78.4% stmts / 73.5% branches / 69.6% funcs / 79.7% lines (`vitest.config.ts`) |
