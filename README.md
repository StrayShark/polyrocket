...
[![coverage](https://img.shields.io/badge/vitest%20cov-87.0%25%20stmts-brightgreen)](./vitest.config.ts)
...
| Coverage gate | vitest 87.0% stmts / 84.1% branches / 80.9% funcs / 88.2% lines (`vitest.config.ts`) |
