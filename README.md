...
[![coverage](https://img.shields.io/badge/vitest%20cov-87.8%25%20stmts-brightgreen)](./vitest.config.ts)
...
| Coverage gate | vitest 87.8% stmts / 85.3% branches / 82.1% funcs / 88.9% lines (`vitest.config.ts`) |
