...
[![coverage](https://img.shields.io/badge/vitest%20cov-79.5%25%20stmts-green)](./vitest.config.ts)
...
| Test totals | **319 cargo + 659 vitest + 85 Python = 1063/** |
| Coverage gate | vitest 79.5% stmts / 75.2% branches / 71.1% funcs / 80.6% lines (`vitest.config.ts`) |
