...
[![coverage](https://img.shields.io/badge/vitest%20cov-88.4%25%20stmts-brightgreen)](./vitest.config.ts)
...
| Coverage gate | vitest 88.4% stmts / 85.8% branches / 82.6% funcs / 89.4% lines (`vitest.config.ts`) |
