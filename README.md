...
[![coverage](https://img.shields.io/badge/vitest%20cov-88.0%25%20stmts-brightgreen)](./vitest.config.ts)
...
| Coverage gate | vitest 88.0% stmts / 85.5% branches / 82.4% funcs / 89.0% lines (`vitest.config.ts`) |
