...
[![coverage](https://img.shields.io/badge/vitest%20cov-69.2%25%20stmts-green)](./vitest.config.ts)
...
| Coverage gate | vitest 69.2% stmts / 65.3% branches / 57.6% funcs / 70.1% lines (`vitest.config.ts`) |
