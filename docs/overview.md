...
>
> 版本：v2.55 · 2026-06-21 (v0.92 + v0.93 + v0.94 — coverage rounds 5/6/7: Settings top save/reset testids, Signals branches, format.ts edges; 33 new tests across 3 files)
