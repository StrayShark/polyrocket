...
[![coverage](https://img.shields.io/badge/vitest%20cov-76.2%25%20stmts-green)](./vitest.config.ts)
...
| Test totals | **319 cargo + 607 vitest + 85 Python = 1011/** |
| Coverage gate | vitest 76.2% stmts / 72.2% branches / 67.4% funcs / 77.3% lines (`vitest.config.ts`) |
